        ...
        <main className="flex-1 min-w-0 flex flex-col">
          ...
          <header className="h-14 shrink-0 flex items-center justify-between px-4 lg:px-5 border-b border-white/10 bg-black/20 backdrop-blur">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="h-9 px-3 rounded-full border border-blue-500/30 bg-blue-500/15 hover:bg-blue-500/20 transition text-sm font-extrabold text-blue-100"
                type="button"
                onClick={openNotifs}
              >
          ...
          <section className="shrink-0 px-4 lg:px-5 py-3 border-b border-white/10 bg-black/10">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                type="button"
                className="h-8 px-4 rounded-full text-xs font-extrabold border border-blue-500/30 bg-blue-500/15 text-blue-200 hover:bg-blue-500/20 transition"

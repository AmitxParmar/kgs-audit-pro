...
export default function ClientOnboardingIATF({ currentUserId, applicationId }: any) {
...
const removeRemoteLocation = (mfgIndex: number, remoteIndex: number) => {
  const updated = [...app.manufacturing_sites];
  updated[mfgIndex].remote_locations =
    updated[mfgIndex].remote_locations.filter((_, i) => i !== remoteIndex);
...
const handleSubmit = async () => {
  ...
  if (!app.outsourced_processes)
    missingFields.push("Outsourced Processes");
...
useEffect(() => {
    ...
    try {
      ...
      if (data.client_id) {
        ...
        setClient({
          ...
          registration_site_address: data.manufacturing_sites?.[0]?.address || "",
        });
      }
  ...
  return (
    <div className="min-h-screen bg-muted py-10 flex justify-center">
    ...
    {[
      ...
      >
        <input
          ...
          onChange={() =>
            toggleArrayValue("applicable_standards", std)
          }
        />
        {std}
      </label>
    ...
    {app.manufacturing_sites.map((site, index) => (
      <div key={index} className="border p-5 rounded-lg space-y-4">
        ...
        <Input
          ...
          onChange={(e) =>
            updateManufacturingSite(index, "site_name", e.target.value)
          }
        />
        ...
        <Textarea
          ...
          value={site.address}
          onChange={(e) =>
            updateManufacturingSite(index, "address", e.target.value)
          }
        />
        ...
        <div className="grid grid-cols-3 gap-4">
          <Input
            ...
            onChange={(e) =>
              updateManufacturingSite(index, "employees_mfg", e.target.value)
            }
          />
          <Input
            ...
            onChange={(e) =>
              updateManufacturingSite(index, "employees_support", e.target.value)
            }
          />
          <Input
        ...
        {index === 0 && (
          <div className="mt-6">
            ...
            {site.remote_locations.map((remote, rIndex) => (
              <div key={rIndex} className="border p-4 rounded-lg space-y-3">
                
                <Input
                  placeholder="Remote Location Name"
                  value={remote.site_name}
                  onChange={(e) =>
                    updateRemoteLocation(index, rIndex, "site_name", e.target.value)
                  }
                />
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateRemoteLocation(index, rIndex, "address", e.target.value)
                  }
                />
                      ...
                      <Command>
                        ...
                        <CommandGroup className="max-h-[260px] overflow-auto">
                          {SUPPORT_FUNCTIONS.map((func) => {
                            const selected =
                              remote.support_functions?.includes(func);

                            return (
                              <CommandItem
                                key={func}
                                onSelect={() =>
                                  toggleRemoteSupportFunction(index, rIndex, func)
                                }
                ...
                <div className="grid grid-cols-3 gap-3">
                  <Input
                    ...
                    onChange={(e) =>
                      updateRemoteLocation(index, rIndex, "employees_support", e.target.value)
                    }
                  />
                ...
                <Button
                  variant="destructive"
                  onClick={() => removeRemoteLocation(index, rIndex)}
                >
...
<Card>
  ...
  <CardContent className="grid grid-cols-3 gap-6">
    ...
    <div>
      ...
      <Input
        ...
        value={app.iaf_code}
        onChange={(e) =>
          setApp({ ...app, iaf_code: e.target.value })
        }
      />
    </div>
  ...
  NACE Code
      ...
      <Input
        ...
        value={app.nace_code}
        onChange={(e) =>
          setApp({ ...app, nace_code: e.target.value })
        }
      />
    </div>
  ...
  SIC Code
      ...
      <Input
        ...
        value={app.sic_code}
        onChange={(e) =>
          setApp({ ...app, sic_code: e.target.value })
        }
      />
    </div>
  </CardContent>
...
<Card>
  ...
  <CardContent className="space-y-4">
    {app.shifts.map((shift, index) => (
      ...
      <Input
  type="time"
  className="bg-background text-white [color-scheme:dark]"
  value={shift.start}
  onChange={(e) => {
...
<Card>
  ...
  <CardContent className="space-y-6">
    ...
    <div>
      <label className="text-sm font-medium">
        Does your company have any relevant legal obligations (bankruptcies, legal proceedings, etc.)?
      </label>
      <div className="flex gap-6 mt-2">
        ...
        <label className="flex items-center gap-2">
          <input
            ...
            onChange={() => setApp({ ...app, legal_obligations: false })}
          />
          No
        </label>
      </div>
    ...
    <div>
      <label className="text-sm font-medium">
        Are you currently certified or have you been previously certified to IATF 16949?
      </label>
      <div className="flex gap-6 mt-2">
        <label className="flex items-center gap-2">
          <input
            ...
            onChange={() => setApp({ ...app, previous_iatf_certified: true })}
          />
          Yes
        </label>
        <label className="flex items-center gap-2">
          <input
            ...
            onChange={() => setApp({ ...app, previous_iatf_certified: false })}
          />
          No
        </label>
      </div>
...
<Card>
  <CardHeader>
    <CardTitle>Automotive Customers are (Automotive Customers (IATF)
)</CardTitle>
  </CardHeader>
...
<Card>
  <CardHeader>
    <CardTitle>Other Automotive OEM / Automotive Customers
</CardTitle>
  </CardHeader>
